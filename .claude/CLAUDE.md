...
### QREMIND
```
Re-read CLAUDE.md and refresh the following critical rules:
...
### QNEW-PYTHON
```
Read CLAUDE.md and focus specifically on Python/FastAPI rules.
...
### QNEW-TYPESCRIPT
```
Read CLAUDE.md and focus specifically on TypeScript/Next.js rules.
